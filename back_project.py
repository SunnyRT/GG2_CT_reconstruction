...
def back_project(sinogram, skip=1, interp='linear'):
	...
	for angle in range(angles):
		...
		# TODO: (RT) 22/05/2024 change the interpolation method by setting:
		# interp = 'linear' or 'nearest' or 'cubic'(b-spline) or 'quadratic'
		x2 = scipy.interpolate.interp1d(np.arange(0, ns, 1), sinogram[angle], kind=interp, copy=False, assume_sorted=True, bounds_error=False, fill_value=0, axis=0)
