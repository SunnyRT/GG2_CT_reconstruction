...
def scan_and_reconstruct(photons, material, phantom, scale, angles, mas=10000, alpha=0.001, noise = False, reconstruct = True, with_filter=True, harden_w = False, hu = False):
